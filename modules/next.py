...
def streamlit():
    ...
    if use_cond:
        ...
        star_strength = st.slider("Star", -1.0, 1.0, 0.0, 0.1)
        hubble_strength = st.slider("Hubble", -1.0, 1.0, 0.0, 0.1)
...
class Network(nn.Module):
    def __init__(self, num_in_ch=3, num_out_ch=3, scale=4, num_feat=64, num_block=6, num_grow_ch=32):
        ...
        self.hubble = self.bytes2torch(b'')
